...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'game.count', 'game_administrator.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('game', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('game_administrator', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'game_administrator',
          header: 'Game Administrator',
          accessorKey: 'game_administrator',
          cell: ({ row: { original: record } }: any) => record?._count?.game_administrator,
        }
      : null,
