...
import {
  ...
  deleteGameAdministratorById,
  createGameAdministrator,
} from 'apiSdk/game-administrators';
      ...
      <Box rounded="md">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6} p={'18px'}>
              <UserPageTable
                createHandler={createGameAdministrator}
                deleteHandler={deleteGameAdministratorById}
                fetcher={getGameAdministrators}
