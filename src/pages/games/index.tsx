...
export function GameListPage(props: GameListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getGames({
        relations: ['company', 'player.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['game_status.contains', 'game_type.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'game_status', header: 'Game Status', accessorKey: 'game_status' },
    { id: 'game_type', header: 'Game Type', accessorKey: 'game_type' },
    {
      id: 'start_time',
      header: 'Start Time',
