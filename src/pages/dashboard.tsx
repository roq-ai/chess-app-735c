...
import { GameAdministratorListPage as ShowCaseList } from 'pages/game-administrators';
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest Game Administrators
                </Text>
                <NextLink href={`game-administrators`} passHref legacyBehavior>
                  <Button
