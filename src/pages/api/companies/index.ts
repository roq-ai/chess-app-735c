...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function createCompany() {
    ...
    if (body?.game_administrator?.length > 0) {
      const create_game_administrator = body.game_administrator;
      body.game_administrator = {
        create: create_game_administrator,
      };
    } else {
      delete body.game_administrator;
    }
