...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'game.create': { roles: ['application-owner'], key: 'game-created', tenantPath: ['company', 'game'], userPath: [] },
  'game.update': {
    roles: ['application-owner'],
    key: 'game-status-updated',
    tenantPath: ['company', 'game'],
    userPath: [],
  },
  'game.delete': { roles: ['application-owner'], key: 'game-deleted', tenantPath: ['company', 'game'], userPath: [] },
  'player.update': {
    roles: ['game-administrator'],
    key: 'player-assigned',
    tenantPath: ['company', 'game', 'player'],
    userPath: [],
  },
  'player.delete': {
    roles: ['game-administrator'],
  ...
  'game_administrator.delete': {
    roles: ['application-owner'],
    key: 'admin-removed',
    tenantPath: ['company', 'game_administrator'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['application-owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['application-owner', 'game-administrator'];
